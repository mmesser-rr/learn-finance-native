    ...
    >
      <Tab.Screen
        ...
        options={{
          ...
          tabBarLabel: ({ focused }) =>
            <Text type='Body/Small' style={focused ? {color: AppColors.accentRed100}: {}}>Home</Text>,
        }}
      />
      <Tab.Screen
        name="Opportunities"
        ...
        options={{
          tabBarIcon: ({ focused }) => (focused ? <ActiveOpportunitiesIcon /> : <OpportunitiesIcon />),
          tabBarLabel: ({ focused }) =>
            <Text type='Body/Small' style={focused ? {color: AppColors.accentRed100}: {}}>Opportunities</Text>,
        }}
      />
      <Tab.Screen
        name="Community"
        component={Community}
        options={{
          tabBarIcon: ({ focused }) => (focused ? <ActiveCommunityIcon /> : <CommunityIcon />),
          tabBarLabel: ({ focused }) =>
            <Text type='Body/Small' style={focused ? {color: AppColors.accentRed100}: {}}>Community</Text>,
        }}
      />
      <Tab.Screen
        name="Profile"
        component={Profile}
        options={{
          tabBarIcon: ({ focused }) => (focused ? <ActiveProfileIcon /> : <ProfileIcon />),
          tabBarLabel: ({ focused }) =>
            <Text type='Body/Small' style={focused ? {color: AppColors.accentRed100}: {}}>Profile</Text>,
        }}
      />
    </Tab.Navigator>
  );
